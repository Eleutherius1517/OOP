...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Product item4 = new HotDrink(200, 4, "Latte", 102, 90);
        Product item5 = new HotDrink(180, 5, "Americano", 103, 90);
        Product item6 = new HotDrink(180, 5, "Tea", 103, 80);
        assort.add(item1);
        assort.add(item2);
        assort.add(item3);
        assort.add(item4);
